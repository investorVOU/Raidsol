      ...
      <div className="relative w-full max-w-lg my-auto bg-[#050505] border-2 sm:border-4 border-red-500/40 p-0.5 tech-border shadow-[0_0_60px_rgba(239,68,68,0.15)] animate-in zoom-in-95 duration-300">
        <div className="p-6 sm:p-10 space-y-6 sm:space-y-8 flex flex-col items-center text-center">
          <div className="w-16 h-16 sm:w-20 sm:h-20 bg-red-500/10 border-2 border-red-500/40 flex items-center justify-center tech-border mb-2 animate-pulse shrink-0">
            <span className="text-3xl sm:text-4xl font-black text-red-500 italic">!</span>
          </div>

          <div>
            <h2 className="text-3xl sm:text-5xl font-black uppercase italic tracking-tighter text-white leading-none">
              ENTRY_<span className="text-red-500">WARNING</span>
            </h2>
            <p className="text-xs sm:text-sm font-black text-red-500/40 uppercase tracking-[0.4em] mt-3 italic">PROTOCOL_RISK_ASSESSMENT</p>
          </div>
          ...
          <p className="text-[9px] sm:text-[10px] text-white/5 font-black uppercase tracking-[0.8em] mt-3 shrink-0">
