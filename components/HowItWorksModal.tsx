      ...
      <div className="relative w-full max-w-lg bg-[#050505] border-4 border-white/10 p-1 tech-border shadow-[0_0_100px_rgba(0,0,0,1)] animate-in zoom-in-95 duration-300 max-h-[90vh] flex flex-col">
        ...
        <div className="p-5 border-b border-white/5 flex justify-between items-center shrink-0">
          <div>
            ...
            <p className="text-xs font-black text-white/50 uppercase tracking-[0.4em] mt-1">Protocol_Mechanics_v7.0</p>
          </div>
          <button onClick={onClose} className="text-white/40 hover:text-white transition-colors font-black text-xl">[X]</button>
        </div>
        ...
        <div className="flex border-b border-white/5 bg-black/50 overflow-x-auto scrollbar-hide shrink-0">
          {([
            ...
            <button
              ...
              className={`flex-1 min-w-[72px] py-3.5 text-[9px] sm:text-[10px] font-black uppercase tracking-widest transition-all whitespace-nowrap px-2 ${activeTab === tab.id ? tab.activeClass : 'text-white/40 hover:text-white/75'}`}
            >
              {tab.label}
            </button>
          ))}
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-5 scrollbar-hide bg-black/40">
          ...
          {activeTab === 'GUIDE' && (
            <div className="space-y-5 animate-in slide-in-from-right-4 duration-300">
              ...
              <div className="space-y-3">
                <h3 className="text-xs font-black uppercase text-white/40 tracking-widest">ACTIONS</h3>
              ...
              <div className="space-y-2">
                <h3 className="text-xs font-black uppercase text-white/40 tracking-widest">COMBO SYSTEM</h3>
                ...
                <p className="text-[10px] text-white/40 italic">5 attacks without defending triggers AGGRESSION surge (+15 risk).</p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 space-y-2">
                <h3 className="text-xs font-black text-white/60 uppercase tracking-widest mb-1">GEAR & PASSES</h3>
          ...
          {activeTab === 'EVENTS' && (
            <div className="space-y-4 animate-in slide-in-from-right-4 duration-300">
              <p className="text-[10px] text-white/50 uppercase tracking-widest">Random events fire during raids. Learn them — they change outcomes.</p>
              ...
              <div className="p-4 bg-white/5 border border-white/10">
                <h3 className="text-xs font-black text-white/60 uppercase tracking-widest mb-2">POST-RAID DEBRIEF</h3>
          ...
          {activeTab === 'PVP' && (
            <div className="space-y-5 animate-in slide-in-from-right-4 duration-300">
              ...
              <div className="p-4 bg-white/5 border border-white/10">
                <h3 className="text-xs font-black uppercase text-white/60 tracking-widest mb-2">LOBBY CHAT</h3>
                <p className="text-[11px] text-white/50 leading-relaxed">
            ...
            <div className="space-y-5 animate-in slide-in-from-right-4 duration-300">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between p-3 bg-white/5 border border-white/10">
                  <span className="text-xs font-black text-white/60 uppercase">Reward formula</span>
                  <span className="text-xs font-black text-yellow-400 mono">(score / 2500) × entry</span>
                </div>
                <div className="flex items-center justify-between p-3 bg-white/5 border border-white/10">
                  <span className="text-xs font-black text-white/60 uppercase">House edge</span>
                  <span className="text-xs font-black text-white mono">~10%</span>
                </div>
                <div className="flex items-center justify-between p-3 bg-white/5 border border-white/10">
                  <span className="text-xs font-black text-white/60 uppercase">Max payout</span>
                  <span className="text-xs font-black text-white mono">6× entry fee</span>
                </div>
                <div className="flex items-center justify-between p-3 bg-white/5 border border-white/10">
                  <span className="text-xs font-black text-white/60 uppercase">On bust</span>
                  <span className="text-xs font-black text-red-400 mono">Entry fee lost</span>
                </div>
              </div>

              <div className="space-y-2">
                <h3 className="text-xs font-black uppercase text-white/40 tracking-widest">BONUSES & SAVINGS</h3>
              ...
              <div className="p-4 bg-red-900/10 border-l-2 border-red-500">
                ...
                <div className="space-y-2 text-xs text-white/60">
                  ...
                  <p><span className="text-white/50">RAGE-QUIT BLOCK</span> — 3 busts in 10 minutes locks you out briefly. Tilt protection.</p>
                </div>
              </div>

              <div className="p-4 bg-white/5 border border-white/10">
                <h3 className="text-xs font-black uppercase text-white/60 tracking-widest mb-2">PROVABLY FAIR</h3>
          ...
          {activeTab === 'REFERRAL' && (
            <div className="space-y-5 animate-in slide-in-from-right-4 duration-300">
              ...
              <div className="flex items-center justify-between p-3 bg-white/5 border border-white/10">
                <span className="text-xs font-black text-white/60 uppercase">SR per recruit</span>
        ...
        <div className="p-5 border-t border-white/5 bg-black shrink-0">
          <div className="flex gap-3 mb-4">
            <button
              ...
              className="flex-1 p-3 bg-white/2 border border-white/5 text-xs font-black uppercase tracking-widest hover:text-white transition-all italic text-white/50"
            >
              Privacy
            </button>
            <button
          ...
          <p className="text-[10px] text-center text-white/20 font-black tracking-[0.3em] uppercase">
