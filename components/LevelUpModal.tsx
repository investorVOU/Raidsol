    ...
    <div className="fixed inset-0 z-[300] flex items-center justify-center p-4">
      ...
      <div
        className="relative w-full max-w-md flex flex-col animate-in zoom-in-110 duration-500
                   bg-[#0c0c20] border-4 tech-border shadow-[0_0_80px_rgba(20,241,149,0.2)]
      ...
      >
        <div className="flex flex-col items-center text-center p-5 sm:p-7">
          ...
          <div className="mt-2 flex items-center gap-3">
            ...
            <span className="text-[9px] font-black uppercase tracking-[0.35em] text-white italic">
          ...
          <div className="mt-5 w-full space-y-2">
            <p className="text-[9px] font-black text-white uppercase tracking-widest mb-2 italic">
            ...
            {rank.perks.map((perk, i) => (
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <p className="text-[8px] font-black text-white uppercase tracking-widest">ACTIVE_ON_LINK_SYNC</p>
                </div>
              </div>
            ))}
          </div>
          ...
          <p className="mt-3 text-[7px] font-black uppercase tracking-[0.5em] text-white italic">
