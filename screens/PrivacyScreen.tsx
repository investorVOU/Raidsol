    ...
    <div className="h-full flex flex-col animate-in slide-in-from-right duration-300" style={{ backgroundColor: 'var(--app-bg)' }}>
      <div className="p-8 shrink-0 border-b border-white/5 flex items-center gap-6">
        ...
        <div>
          ...
          <p className="text-xs font-black text-white uppercase tracking-[0.4em] mt-2">Data_Handling_Policy_v4.2</p>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto p-8 space-y-12 scrollbar-hide">
        ...
        <div className="p-8 border-2 border-dashed border-white/5 tech-border text-center">
          <p className="text-xs font-black uppercase tracking-[0.5em] text-white italic">__END_OF_DISCLOSURE__</p>
        </div>
      </div>
    </div>
  );
