    ...
    <div className="h-full flex flex-col bg-[#000000] animate-in slide-in-from-right duration-300">
      <div className="p-8 shrink-0 border-b border-white/5 flex items-center gap-6">
        ...
        <div>
          ...
          <p className="text-xs font-black text-white/40 uppercase tracking-[0.4em] mt-2">Rules_of_Engagement_v4.2</p>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto p-8 space-y-12 scrollbar-hide">
        ...
        <section>
          <div className="flex items-center gap-4 mb-4">
             <div className="px-4 py-1.5 bg-white/5 border border-white/10 text-xs font-black text-white/60 uppercase italic">_03</div>
        ...
        <div className="py-12 text-center border-t border-white/5">
          <p className="text-xs font-black uppercase tracking-[0.5em] text-white/20 italic">__PROCEED_ONLY_WITH_ICE_IN_VEINS__</p>
        </div>
      </div>
    </div>
  );
