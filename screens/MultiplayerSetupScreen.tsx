  ...
  if (activeRoom) {
    return (
      <div className="h-full flex flex-col animate-in fade-in duration-300 relative bg-black">
        ...
        {/* Join notification */}
        {joinNotification && (
          <div className="absolute top-20 left-1/2 -translate-x-1/2 z-[300] w-max max-w-xs bg-[#14F195]/15 border border-[#14F195] px-5 py-3 text-xs font-bold text-[#14F195] animate-in slide-in-from-top-4 duration-300 shadow-[0_0_20px_rgba(20,241,149,0.3)]">
            {joinNotification}
          </div>
        )}
              ...
              <div className="divide-y divide-white/5">
                {players.map((player, i) => (
                  <div key={player.id} className="flex items-center gap-3 px-4 py-3 animate-in slide-in-from-left duration-300" style={{ animationDelay: `${i * 80}ms` }}>
                    ...
                    <span className={`flex-1 text-sm font-bold ${player.id === walletAddress ? 'text-[#14F195]' : 'text-white'}`}>
                      {player.name} {player.id === walletAddress && <span className="text-[9px] text-[#14F195]/50">(you)</span>}
                    </span>
                    <span className="text-[9px] font-bold text-[#14F195] bg-[#14F195]/10 border border-[#14F195]/20 px-2 py-0.5">Ready</span>
                  </div>
                ))}
            ...
            <div className="bg-[#09090b] border border-white/8 tech-border overflow-hidden">
              ...
              <div className="flex gap-1.5 p-2 border-t border-white/5">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-[#9945FF]/20 border border-[#9945FF]/40 text-[#9945FF] text-xs font-bold hover:bg-[#9945FF]/30 transition-colors disabled:opacity-20 disabled:cursor-not-allowed"
                >
                  Send
                </button>
              </div>
          ...
          {view === 'CREATE' && (
            <div className="space-y-5 py-2">
              ...
              <button
                ...
                disabled={isCreating}
                className="w-full py-5 sm:py-6 bg-[#9945FF] text-white tech-border font-bold uppercase tracking-tight text-xl sm:text-2xl shadow-[0_0_25px_rgba(153,69,255,0.3)] hover:bg-[#8035e0] active:scale-[0.99] transition-all disabled:opacity-60 disabled:cursor-not-allowed"
              >
            ...
            <div className="space-y-4 py-2">
              ...
              {!joinPreview ? (
                <button
                  ...
                  className="w-full py-5 bg-white text-black tech-border font-bold uppercase tracking-tight text-xl hover:bg-[#14F195] transition-all active:scale-[0.99] disabled:opacity-40 disabled:cursor-not-allowed"
                >
                ...
                <button
                  ...
                  disabled={isJoining}
                  className="w-full py-5 bg-cyan-500 text-black tech-border font-bold uppercase tracking-tight text-xl shadow-[0_0_20px_rgba(6,182,212,0.3)] hover:bg-cyan-400 active:scale-[0.99] transition-all disabled:opacity-60"
                >
                ...
                <button
                  ...
                  className="w-full py-5 bg-[#9945FF] text-white tech-border font-bold uppercase tracking-tight text-xl shadow-[0_0_25px_rgba(153,69,255,0.3)] hover:bg-[#8035e0] active:scale-[0.99] transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                >
