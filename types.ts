...
export const GEAR_ITEMS: Equipment[] = [
  ...
  { id: 'gear_std_1', name: 'Scrap Dagger', type: 'GEAR', rarity: 'STANDARD', description: 'Crude but effective for rapid extractions.', price: 0.05, effect: 'MULT_BOOST', benefitValue: 0.05, image: 'https://img.icons8.com/pixel-cutie/100/dagger.png' },
  { id: 'gear_std_2', name: 'Logic Wrench', type: 'GEAR', rarity: 'STANDARD', description: 'Adjusts protocol flows. -2% Risk.', price: 0.08, effect: 'RISK_REDUCTION', benefitValue: 2, image: 'https://img.icons8.com/pixel-cutie/100/wrench.png' },
  { id: 'gear_std_3', name: 'Data Pick', type: 'GEAR', rarity: 'STANDARD', description: 'Precision tool for minor nodes. +2s Time.', price: 0.10, effect: 'TIME_BOOST', benefitValue: 2, image: 'https://img.icons8.com/pixel-cutie/100/pickaxe.png' },
  { id: 'gear_std_4', name: 'Work Hammer', type: 'GEAR', rarity: 'STANDARD', description: 'Heavy-duty smashing tool for basic firewalls.', price: 0.12, effect: 'MULT_BOOST', benefitValue: 0.1, image: 'https://img.icons8.com/pixel-cutie/100/hammer.png' },
  { id: 'gear_std_5', name: 'Scrap Buckler', type: 'GEAR', rarity: 'STANDARD', description: 'Improvisational shield for low-level raids.', price: 0.15, effect: 'RISK_REDUCTION', benefitValue: 4, image: 'https://img.icons8.com/pixel-cutie/100/shield.png' },
  { id: 'gear_std_6', name: 'Rusty Axe', type: 'GEAR', rarity: 'STANDARD', description: 'Reliable for harvesting bulk data fragments.', price: 0.18, effect: 'MULT_BOOST', benefitValue: 0.12, image: 'https://img.icons8.com/pixel-cutie/100/axe.png' },
  { id: 'gear_std_7', name: 'Short Sword', type: 'GEAR', rarity: 'STANDARD', description: 'The basic choice for any aspiring raider.', price: 0.22, effect: 'MULT_BOOST', benefitValue: 0.15, image: 'https://img.icons8.com/pixel-cutie/100/sword.png' },

  // --- LIMITED GEAR (8 items) ---
  { id: 'gear_lim_1', name: 'Pulse Blade', type: 'GEAR', rarity: 'LIMITED', description: 'Vibrating edge cuts through encryption faster.', price: 0.45, effect: 'MULT_BOOST', benefitValue: 0.3, image: 'https://img.icons8.com/pixel-cutie/100/switchblade.png', minLevel: 5 },
  { id: 'gear_lim_2', name: 'Nano Bow', type: 'GEAR', rarity: 'LIMITED', description: 'Ranged extraction tether. +8s Raid Time.', price: 0.60, effect: 'TIME_BOOST', benefitValue: 8, image: 'https://img.icons8.com/pixel-cutie/100/bow.png', minLevel: 5 },
  { id: 'gear_lim_3', name: 'Plasma Guard', type: 'GEAR', rarity: 'LIMITED', description: 'Energy shield for mid-layer stability. -10% Risk.', price: 0.75, effect: 'RISK_REDUCTION', benefitValue: 10, image: 'https://img.icons8.com/pixel-cutie/100/security-checked.png', minLevel: 10 },
  { id: 'gear_lim_4', name: 'Circuit Smasher', type: 'GEAR', rarity: 'LIMITED', description: 'Massive impact destabilizes security nodes.', price: 0.90, effect: 'MULT_BOOST', benefitValue: 0.45, image: 'https://img.icons8.com/pixel-cutie/100/sledgehammer.png', minLevel: 10 },
  { id: 'gear_lim_5', name: 'Void Katana', type: 'GEAR', rarity: 'LIMITED', description: 'Shadow-tech blade for silent extractions.', price: 1.2, effect: 'MULT_BOOST', benefitValue: 0.5, image: 'https://img.icons8.com/pixel-cutie/100/sword.png', minLevel: 12 },
  { id: 'gear_lim_6', name: 'Flux Scythe', type: 'GEAR', rarity: 'LIMITED', description: 'Sweeps through large data pools effortlessly.', price: 1.5, effect: 'MULT_BOOST', benefitValue: 0.65, image: 'https://img.icons8.com/pixel-cutie/100/scythe.png', minLevel: 12 },
  { id: 'gear_lim_7', name: 'Plasma Trident', type: 'GEAR', rarity: 'LIMITED', description: 'Triple extraction points for high efficiency.', price: 1.8, effect: 'MULT_BOOST', benefitValue: 0.7, image: 'https://img.icons8.com/pixel-cutie/100/trident.png', minLevel: 15 },
  { id: 'gear_lim_8', name: 'Heavy Barrier', type: 'GEAR', rarity: 'LIMITED', description: 'Mobile firewall defense. -15% Risk.', price: 2.2, effect: 'RISK_REDUCTION', benefitValue: 15, image: 'https://img.icons8.com/pixel-cutie/100/shield.png', minLevel: 15 },

  // --- EXCLUSIVE GEAR (5 items) ---
  { id: 'gear_exc_1', name: 'Omega Railgun', type: 'GEAR', rarity: 'EXCLUSIVE', description: 'Shatters the most advanced protocol walls.', price: 5.0, effect: 'MULT_BOOST', benefitValue: 1.2, image: 'https://img.icons8.com/pixel-cutie/100/tommy-gun.png', minLevel: 20 },
  { id: 'gear_exc_2', name: 'Quantum Saber', type: 'GEAR', rarity: 'EXCLUSIVE', description: 'A blade made of pure Solana energy.', price: 8.5, effect: 'RISK_REDUCTION', benefitValue: 25, image: 'https://img.icons8.com/pixel-cutie/100/lightsaber.png', minLevel: 25 },
  { id: 'gear_exc_3', name: 'Chainsaw_0x', type: 'GEAR', rarity: 'EXCLUSIVE', description: 'Brute force extraction. Extremely fast yield.', price: 12.0, effect: 'MULT_BOOST', benefitValue: 1.8, image: 'https://img.icons8.com/pixel-cutie/100/chainsaw.png', minLevel: 30 },
  { id: 'gear_exc_4', name: 'Singularity Core', type: 'GEAR', rarity: 'EXCLUSIVE', description: 'Bends the raid clock. +30s Raid Time.', price: 15.0, effect: 'TIME_BOOST', benefitValue: 30, image: 'https://img.icons8.com/pixel-cutie/100/nuclear-power-plant.png', minLevel: 40 },
  { id: 'gear_exc_5', name: 'Protocol God Axe', type: 'GEAR', rarity: 'EXCLUSIVE', description: 'Legendary tool of the chain creators.', price: 25.0, effect: 'MULT_BOOST', benefitValue: 3.0, image: 'https://img.icons8.com/pixel-cutie/100/battle-axe.png', minLevel: 50 }
];
